...
func _ready():
	...
	if Global.player != null:
		var health_component = Global.player.get_node("HealthComponent") 
...
func _spawn_enemies():
	...
	for n in enemy_count:
		...
		var enemy_type = randi_range(0, len(enemy_array) - 1)
...
func _on_player_dead(_health_update: HealthUpdate):
	level_music.stop()
